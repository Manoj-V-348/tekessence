    ...
    <>
      <div className="home--container">
        <div className="carousel home--carousel">
          ...
          <p>
            TekEssence is a unique Innovation services firm that can multiple
            the enterprise value of a business, while lowering its non-core
            operating costs.
          </p>
        </div>

        <div className="home--text--container horizontal--flex">
          ...
          <div className="text--container vertical--flex">
            <p>
              ...
              Innovation Capital, an advisory service that is revolutionary in
              the world of strategy consulting and private investments. We are
              transforming small & medium sized businesses in targeted
              industries - or divisions of large corporates - that are in the
              midst of great flux.
            </p>
            <br />
            <p>
              Our client partners are typically niche leaders in their industry
              segment who could be re-positioned to disrupt existing markets,
              and appreciate a committed partner to share in the risk/reward of
              a transformative venture. As outsiders we view the business
              through the impartial lens of continuous innovation. As insiders
              we take a hands-on approach to operating all non-core aspects of
              the business. As entrepreneurs we have a finger on the pulse of
              cutting edge technologies that can prove a differentiating edge to
              business functions.
            </p>
            <br />
            <p>
